            ...
            <header className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div className="navbar-collapse collapse d-flex justify-content-end">
                    <ul className="navbar-nav float-right">
                        ...
                        <li className="nav-item">
                            {appState.token !== null? <button onClick={(e) => logOutClicked(e.nativeEvent, "/Home/Index")} className="nav-link btn btn-link text-dark">Logout</button>:
                            <button onClick={(e) => logOutClicked(e.nativeEvent, "/Identity/Login")} className="nav-link btn btn-link text-dark">Login</button>
                            }
